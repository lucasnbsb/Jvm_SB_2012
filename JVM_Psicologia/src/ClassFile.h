...
typedef struct classfile {
    ...
    fieldInfo    	*fields; //deve ser alocado com fields[fields_count] ,  cada valor deve ser um field_info(4.5 na fonte) com a descição completa de um field na classe em questão TODO implementar field_info
